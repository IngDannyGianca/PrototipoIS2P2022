...
{
    public partial class frmasignacioncursosmastros : Form
    {
        public frmasignacioncursosmastros()
        {
            InitializeComponent();
			...
			navegador1.ObtenerCamposdeTabla(alias, "asignacioncursosmastros", "hotelsancarlos");
			...
			navegador1.LlenarCombobox(comboBox7, "maestros", "codigo_maestro", "nombre_maestro", "estatus_maestro");
