...
namespace CapaVistaRRHH
{
    public partial class frmCursos : Form
    {
        ...
        {
			navegador1.CambioEstadoTextbox(estatus_curso, rbnEstatusamodulo, "1");
		}

        private void rbnEstatusimodulo_CheckedChanged(object sender, EventArgs e)
        {
			navegador1.CambioEstadoTextbox(estatus_curso, rbnEstatusamodulo, "0");
		}

        private void txtEstado_TextChanged(object sender, EventArgs e)
        {
			navegador1.ActivaRadiobtn(rbnEstatusamodulo, rbnEstatusimodulo, estatus_curso);
		}
